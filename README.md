...
generated based on the specified property names unless one has been specified 
explicitly in the tree options. If the properties relate to each other in a way that 
